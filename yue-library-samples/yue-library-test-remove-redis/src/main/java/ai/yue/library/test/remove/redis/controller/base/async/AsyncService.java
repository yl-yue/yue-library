package ai.yue.library.test.remove.redis.controller.base.async;

import ai.yue.library.base.exception.ResultException;
import ai.yue.library.base.view.Result;
import ai.yue.library.data.jdbc.ipo.PageIPO;
import ai.yue.library.data.jdbc.vo.PageVO;
import ai.yue.library.test.remove.redis.controller.data.jdbc.query.map.PersonDAO;
import ai.yue.library.test.remove.redis.controller.data.jdbc.query.map.PersonDO;
