...
import ai.yue.library.data.mybatis.config.MybatisAutoConfig;
...
public class LogAutoConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "yue.data.log", name = "auto-create-table", havingValue = "true", matchIfMissing = true)
