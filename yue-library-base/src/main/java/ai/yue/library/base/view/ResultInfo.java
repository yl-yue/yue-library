...
public class ResultInfo {
	...
	/**
	 * 自定义类型提示-result
	 * @deprecated {@linkplain Result#setMsg(String)}
	 * @param result	提示Result
	 * @param msg		替换消息
	 * @return
	 */
	@Deprecated
	public static Result<?> dev_defined(Result<?> result, String msg) {
		return ResultUtils.error(result.getCode(), msg);
	}
