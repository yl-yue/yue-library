...
public class YueJavaBeanDeserializer implements ObjectDeserializer {
    ...
    public YueJavaBeanDeserializer(ParserConfig config, Class<?> clazz) {
        this(config, clazz, clazz);
    }

    public YueJavaBeanDeserializer(ParserConfig config, Class<?> clazz, Type type){
        this(config //
    ...
    public YueJavaBeanDeserializer(ParserConfig config, JavaBeanInfo beanInfo){
    ...
    public <T> T deserialzeArrayMapping(DefaultJSONParser parser, Type type, Object fieldName, Object object) {
        ...
        if ((typeName = lexer.scanTypeName(parser.symbolTable)) != null) {
            ...
            if (deserializer instanceof YueJavaBeanDeserializer) {
                return ((YueJavaBeanDeserializer) deserializer).deserialzeArrayMapping(parser, type, fieldName, object);
            }
        }
...
//                        customDeserializer = ((DefaultFieldDeserializer) fieldDeserializer).customDeserilizer;
                        customDeserializer = (boolean) ReflectUtil.getFieldValue(((DefaultFieldDeserializer) fieldDeserializer), "customDeserilizer");
                    }
                }
...
//                            ObjectDeserializer fieldValueDeserilizer = ((DefaultFieldDeserializer) fieldDeserializer).fieldValueDeserilizer;
                            ObjectDeserializer fieldValueDeserilizer = (ObjectDeserializer) ReflectUtil.getFieldValue(((DefaultFieldDeserializer) fieldDeserializer), "fieldValueDeserilizer");
                ...
                if (!matchField) {
                    ...
                    if ((typeKey != null && typeKey.equals(key))
                        ...
                        if (lexer.token() == JSONToken.LITERAL_STRING) {
                            ...
                            if (deserializer instanceof YueJavaBeanDeserializer) {
                                YueJavaBeanDeserializer javaBeanDeserializer = (YueJavaBeanDeserializer) deserializer;
                                if (typeKey != null) {
...
//                    throw new JSONException("not match enum value, " + enumDeserializer.enumClass);
                    throw new JSONException("not match enum value, " + ReflectUtil.getFieldValue(enumDeserializer, "enumClass"));
                }
            }
            ...
            for (int i = 0; i < this.sortedFieldDeserializers.length; i++) {
                ...
                if (fieldInfo.unwrapped //
                    ...
                    if (fieldInfo.field != null) {
                        ...
                        if (fieldValueDeser instanceof YueJavaBeanDeserializer) {
                            YueJavaBeanDeserializer javaBeanFieldValueDeserializer = (YueJavaBeanDeserializer) fieldValueDeser;
                            ...
                            if (unwrappedFieldDeser != null) {
                                ...
                                try {
                                    ...
                                    if (fieldObject == null) {
                                        fieldObject = ((YueJavaBeanDeserializer) fieldValueDeser).createInstance(parser, fieldInfo.fieldType);
    ...
    protected static YueJavaBeanDeserializer getSeeAlso(ParserConfig config, JavaBeanInfo beanInfo, String typeName) {
        if (beanInfo.jsonType == null) {
            return null;
        }
        ...
        for (Class<?> seeAlsoClass : beanInfo.jsonType.seeAlso()) {
            ...
            if (seeAlsoDeser instanceof YueJavaBeanDeserializer) {
                YueJavaBeanDeserializer seeAlsoJavaBeanDeser = (YueJavaBeanDeserializer) seeAlsoDeser;
                ...
                YueJavaBeanDeserializer subSeeAlso = getSeeAlso(config, subBeanInfo, typeName);
                if (subSeeAlso != null) {
                    return subSeeAlso;
                }
            }
