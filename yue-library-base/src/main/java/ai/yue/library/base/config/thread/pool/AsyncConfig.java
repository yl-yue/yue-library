...
@ConditionalOnProperty(prefix = "yue.thread-pool.async", name = "enabled", havingValue = "true", matchIfMissing = true)
public class AsyncConfig implements AsyncConfigurer {
	...
	public ThreadPoolTaskExecutor getThreadPoolTaskExecutor() {
		...
		log.info("【初始化 {} 线程池】共用父线程上下文环境，异步执行任务时不丢失token ...", threadNamePrefix);
		return executor;
	}
